...
### (vi - A) Display the total salary given to each department.
...
### (vi - B) Display the total salary given to 'SALESMAN'.
...
### (vii) Display the name of the employee getting second maximum salary.
...
### (viii) Display the name and salary of those employees who are working in the same department as Ford.
...
### (ix) Display the name and designation of those employees who are getting a commission.
...
### (x) Display the description of the table structure Employee.
